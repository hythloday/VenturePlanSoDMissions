...
T.MoreSpells = {
    ...
    [330]={type="aura", target="all-allies", duration=2, plusDamageDealtATK=24}, --Oversight
    [331]={type="aura", target="all-other-allies", duration=3, plusDamageDealtATK=24}, --Supporting Fire
